    ...
    <form method="POST" action="{{ route('activities.update', $activity) }}" class="space-y-6" novalidate>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <div class="md:col-span-2">
                    <flux:radio.group name="is_active" :label="__('Record state')" variant="segmented" required>
                        <flux:radio
                            value="1"
                            :checked="(string) old('is_active', $activity->is_active ? '1' : '0') === '1'"
                        >
                            {{ __('Active') }}
                        </flux:radio>
                        <flux:radio
                            value="0"
                            :checked="(string) old('is_active', $activity->is_active ? '1' : '0') === '0'"
                        >
                            {{ __('Inactive') }}
                        </flux:radio>
                    </flux:radio.group>
        ...
        <flux:card>
            <div class="mb-4 space-y-1">
                ...
                <flux:subheading>{{ __('Keep the timeline accurate and update follow-up commitments.') }}</flux:subheading>
            </div>
            ...
            <div class="grid gap-4 md:grid-cols-2">
                ...
                <flux:input
                    ...
                    type="date"
                    :value="old('next_follow_up_at', $activity->next_follow_up_at?->format('Y-m-d'))"
                />
